    ...
    override fun getActions(context: Context): List<ActionModel> {
        return listOf(
            ...
            ActionModel(
                ...
                icon = AppCompatResources.getDrawable(context, R.drawable.point_mainapp_demo_app_ic_bluetooth),
            ...
            ActionModel(
                ...
                icon = AppCompatResources.getDrawable(context, R.drawable.point_mainapp_demo_app_ic_qr_code),
